...
public class CompetitorList {
	 ...
	 * number,firstName
	 * lastName,level,age,country,score1,score2,score3,score4,score5
	 * 
	...
	public void readFile(String fileName) {
		try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
			...
			while ((str = br.readLine()) != null) {
				...
				Competitor competitor = new Competitor(number, new Name(firstName, lastName), getLevelNumber(level),
						age, country, scores);
	...
	public void reportToFile(String fileName) {
		...
		try {
			...
			int maxIndex = 0;
			double maxOverall = competitorList.get(0).getOverallScore();

			int minIndex = 0;
			double minOverall = competitorList.get(0).getOverallScore();
			...
			myWriter.write("There are " + competitorList.size() + " competitors\n");
			myWriter.write(
					"The person with the highest score is " + competitorList.get(maxIndex).getName().getFullName()
							+ " with a score of " + competitorList.get(maxIndex).getOverallScore() + ".\n");
			myWriter.write("The person with the lowest score is " + competitorList.get(minIndex).getName().getFullName()
					+ " with a score of " + competitorList.get(minIndex).getOverallScore() + ".\n");
